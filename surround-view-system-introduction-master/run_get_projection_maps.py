...
def main():
  ...
  #  image_file = os.path.join(os.getcwd(), "images", camera_name + ".jpg")
    camera_file = os.path.join(os.getcwd(), settings.yamldir, camera_name + ".yaml")
    image_file = os.path.join(os.getcwd(), settings.project_imgpath, camera_name + settings.project_imgtype)
